...
export function renderHelp(): string {
  return [
    ...
    "  command  Run argv or an explicit shell script in a selected sandbox",
    ...
    "  --prompt-stdin        Read initial prompt/follow-up from stdin",
    "  --timeout-ms <ms>     Remote command timeout",
    "  --shell <script>      Run an intentional remote shell script",
    "  --shell-file <path>   Run a local file as a remote shell script",
    "  --json                Structured JSON output; does not imply --detach",
